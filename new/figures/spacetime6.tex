...
\begin{tikzpicture}[scale=1.8]
  ...
  \node[mydarkorange,above right] at (-0.95*\xmax,\xmax) {Framtíðarljóskeila};
  \node[mydarkorange,below] at (0,-\xmax) {Fortíðarljóskeila};
  \node[mydarkgreen,above right] at (0.1*\xmax,\xmax) {Söguferill agnar};
  ...
  \node[mydarkblue,right,align=center] at (-\xmax,0.18*\xmax)
    {\contour{myblue!5}{Rúmlægir}\\[-2]\contour{myblue!5}{atburðir}};
  \node[mydarkblue,left,align=center] at (\xmax,0.18*\xmax)
    {\contour{myblue!5}{Rúmlægir}\\[-2]\contour{myblue!5}{atburðir}};
  \node[mydarkorange,align=center] at (-0.25*\xmax,0.67*\xmax)
    {\contour{myorange!5}{Tímalægir}\\[-2]\contour{myorange!5}{atburðir}};
  \node[mydarkorange,align=center] at (0.25*\xmax,-0.67*\xmax)
    {\contour{myorange!5}{Tímalægir}\\[-2]\contour{myorange!5}{atburðir}};
