...
%%%
%
\setcounter{chapter}{20} % one less than this chapter
%
%%%
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
    \centering
    \subfloat{{\includegraphics[scale = 1]{figures/up-quark.pdf}
         }}%
    \qquad
    \subfloat{{\includegraphics[scale = 1]{figures/nidur-quark.pdf} }}%
\end{figure}
