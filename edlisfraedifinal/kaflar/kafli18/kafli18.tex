...
%%%
%
\setcounter{chapter}{17} % one less than this chapter
%
%%%
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
\hfill
\subfigure{\includegraphics[scale = 0.075]{figures/magnetic_field_loop-003.png}}
\hfill
\subfigure{\includegraphics[scale = 0.18]{figures/magnet_fieldlines_dipoles.png}}
\hfill
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics{figures/segull1.pdf}
\end{figure}
\end{comment}
...
\begin{figure}[H]
\hfill
\subfigure{\includegraphics[scale = 0.1]{figures/magnetic_field_wire_force-001.png}}
\hfill
\subfigure{\includegraphics[scale = 0.1]{figures/magnetic_field_wire_force-002.png}}
\hfill
\end{figure}
